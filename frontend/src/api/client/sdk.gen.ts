...
/**
 * Get Candidate Self
 * Get candidate information by UUID without authentication.
 * This is a secure endpoint for candidates to access their own data.
 */
export const getCandidateSelfCandidatesSelfCandidateIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCandidateSelfCandidatesSelfCandidateIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCandidateSelfCandidatesSelfCandidateIdGetResponses, GetCandidateSelfCandidatesSelfCandidateIdGetErrors, ThrowOnError>({
        responseType: 'json',
        url: '/candidates/self/{candidate_id}',
        ...options
    });
};

/**
 * Update Candidate Self
 * Update candidate information by UUID without authentication.
 * This is a secure endpoint for candidates to update their own data.
 */
export const updateCandidateSelfCandidatesSelfCandidateIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateCandidateSelfCandidatesSelfCandidateIdPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateCandidateSelfCandidatesSelfCandidateIdPatchResponses, UpdateCandidateSelfCandidatesSelfCandidateIdPatchErrors, ThrowOnError>({
        responseType: 'json',
        url: '/candidates/self/{candidate_id}',
        ...options,
        headers: {
 ...
 * Upload resume for a candidate by UUID without authentication.
 * This is a secure endpoint for candidates to upload their resume.
 */
export const uploadCandidateResumeCandidatesSelfCandidateIdUploadResumePost = <ThrowOnError extends boolean = false>(options: Options<UploadCandidateResumeCandidatesSelfCandidateIdUploadResumePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UploadCandidateResumeCandidatesSelfCandidateIdUploadResumePostResponses, UploadCandidateResumeCandidatesSelfCandidateIdUploadResumePostErrors, ThrowOnError>({
        ...formDataBodySerializer,
        responseType: 'json',
        url: '/candidates/self/{candidate_id}/upload-resume',
        ...options,
        headers: {
            'Content-Type': null,
            ...options.headers
